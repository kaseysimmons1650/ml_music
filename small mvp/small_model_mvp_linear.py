...
train_ds, val_ds = tf.keras.utils.image_dataset_from_directory(
    ...
    color_mode='rgb',
    batch_size=2, #had to change batch size to small number for small dataset
    image_size=(256, 256),
    shuffle=True,
    seed=123,
...
model = Sequential([
  ...
  layers.Conv2D(16, 3, padding='same', activation='linear'),
  layers.MaxPooling2D(),
  layers.Conv2D(32, 3, padding='same', activation='linear'),
  layers.MaxPooling2D(),
  layers.Conv2D(64, 3, padding='same', activation='linear'),
  layers.MaxPooling2D(),
  # layers.Conv2D(128, 3, padding='same', activation='linear'),
  # layers.MaxPooling2D(),
...
model.save('small_mvp_model_linear')