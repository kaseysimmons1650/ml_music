...
train_ds, val_ds = tf.keras.utils.image_dataset_from_directory(
    spec_dir,
    labels='inferred', #label names from folder names
    label_mode='int', 
    color_mode='rgb',
    batch_size=512, #edited batch size
    image_size=(256, 256),
    seed=123,
...
#break validation into testing and training
...
model = Sequential([
  ...
  layers.Dense(num_classes) #classification - one node every label
])
...
#model.save('tempo_classification')